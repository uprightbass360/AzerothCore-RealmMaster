...
declare -A TEMPLATE_VALUE_MAP=(
  ...
  [DEFAULT_COMPOSE_OVERRIDE_SOAP_ENABLED]=COMPOSE_OVERRIDE_SOAP_ENABLED
  [DEFAULT_COMPOSE_OVERRIDE_ACCOUNT_PORTAL_ENABLED]=COMPOSE_OVERRIDE_ACCOUNT_PORTAL_ENABLED
