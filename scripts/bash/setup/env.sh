...
setup_write_env() {
  ...
  COMPOSE_OVERRIDE_SOAP_ENABLED=${COMPOSE_OVERRIDE_SOAP_ENABLED:-$DEFAULT_COMPOSE_OVERRIDE_SOAP_ENABLED}
  COMPOSE_OVERRIDE_ACCOUNT_PORTAL_ENABLED=${COMPOSE_OVERRIDE_ACCOUNT_PORTAL_ENABLED:-$DEFAULT_COMPOSE_OVERRIDE_ACCOUNT_PORTAL_ENABLED}
...
# soap-enable.yml -> enables the worldserver SOAP API via COMPOSE_OVERRIDE_SOAP_ENABLED
# account-portal.yml -> runs the Account Portal web app via COMPOSE_OVERRIDE_ACCOUNT_PORTAL_ENABLED
...
COMPOSE_OVERRIDE_SOAP_ENABLED=$COMPOSE_OVERRIDE_SOAP_ENABLED
COMPOSE_OVERRIDE_ACCOUNT_PORTAL_ENABLED=$COMPOSE_OVERRIDE_ACCOUNT_PORTAL_ENABLED
